                ...
                ">
                    <div class="col-lg-2 col-md-2 col-sm-10 d-none d-lg-block p-0"> 
                        <div class="sidebar z-1020 cat-hover category-shadow-sm pt-0" style="background-color: #f5f7fa;">
                            <div
                                class="pr-3 pl-3 pt-2 pb-1 d-none d-lg-block all-category position-relative text-left">
                                    ...
                                    <div class="fs-14 fw-600 px-3">
                                        ...
                                        <div class="px-5">
                                            <div class="aiz-checkbox-list">
                                                ...
                                                <label class="aiz-checkbox">
                                                        <input type="checkbox" name="CorporateAds" value="CorporateAds" onchange="filter()">
                                                        <span class="aiz-square-check"></span>
                                ...
                                <div id="myCarousel"  class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        ...
                                        <div class="carousel-item active">
                                            <a href="">
                                            <img src="{{ asset('frontend/assets/images/ad.jpg') }}" alt="" class="banner1">
                                        </a>
                                        </div>
                                
                                    <div class="carousel-item">
                                        <a href="">
                                            <img src="{{ asset('frontend/assets/images/banner7.png') }}" alt="" class="banner1">
                                        </a>
    ...
    <section id='allOffer' class="">
        <div class="container py-4">
            <div class="row">
                ...
                <div class="col-lg-10">
                    <h2 class="py-3 text-left w-700" style="font-size:24px; font-family: 'Roboto', sans-serif;">All Offer</h2>
                    ...
                    <div id="secondCarousel"  class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <a href="">
                                <img src="{{ asset('frontend/assets/images/banner6.jpg') }}" alt="" class="banner1">
                            </a>
                            </div>
                                    
                    <div class="carousel-item">
                        <a href="">
                            <img src="{{ asset('frontend/assets/images/banner8.png') }}" alt="" class="banner1">                       
                        </a>
                                        ...
                                        <div class="owl-carousel owl-theme bbb_viewed_slider d-flex">
                                            <div class="owl-item">
                                                <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                    <div class="bbb_viewed_image"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560924153/alcatel-smartphones-einsteiger-mittelklasse-neu-3m.jpg" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="owl-item">
                                                <div class="bbb_viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                                    <div class="bbb_viewed_image"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560924221/51_be7qfhil.jpg" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="owl-item">
                                ...
                                <div class="bbb_main_container">
                                    ...
                                    <div class="bbb_viewed_slider_container">
                                        <div class="owl-carousel owl-theme bbb_viewed_slider_2 d-flex">
                                            <div class="owl-item">
                                                <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                    <div class="bbb_viewed_image-2"><img src="{{ asset('frontend/assets/images/m2.jpeg') }}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="owl-item">
                                                <div class="bbb_viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                                    <div class="bbb_viewed_image-2"><img src="{{ asset('frontend/assets/images/m3.jpeg') }}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="owl-item">
                                                <div class="bbb_viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                                    <div class="bbb_viewed_image-2"><img src="{{ asset('frontend/assets/images/d1.jpg') }}" alt=""></div>
                                                </div>
                                            </div>
                                           
                                            <div class="owl-item">
                                                <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                    <div class="bbb_viewed_image-2"><img src="{{ asset('frontend/assets/images/m2.jpeg') }}" alt=""></div>
                                                </div>
                                            </div>
                                            <div class="owl-item">
                                                <div class="bbb_viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                                    <div class="bbb_viewed_image-2"><img src="{{ asset('frontend/assets/images/h1.jpg') }}" alt=""></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <section id='saleAd' class="">
        ...
        <div class="container py-4">
            <div class="row">
                <div class="col-lg-2"></div>
                <div class="col-lg-10">
                    <h2 class="py-3 text-left w-700" style="font-size:24px; font-family: 'Roboto', sans-serif;">All Sale Ad</h2>
                    <div id="thirdCarousel"  class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div id="thirdCarousel"  class="carousel slide" data-ride="carousel">
                            <div class="carousel-item active">
                                <img src="{{ asset('frontend/assets/images/slider1.jpg') }}" alt="" class="banner1">
                            </div>
            ...
            <div class="pt-4">
                <div class="row" id='saleProduct'>
                    ...
                    <div class="col-lg-5 col-sm-12">
                        <div class="content"><a href="#">
                                <img src="{{ asset('frontend/assets/images/s3.jpg') }}" alt="" class="saleimg-mt">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="pt-4">
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="content"><a href="#">
                            <img src="{{ asset('frontend/assets/images/s4.jpg') }}" alt="" class="saleimg-mt">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-4">
                <div class="col-lg-2"></div>
                <div class="col-lg-10">
                <a href = "#" class="ml-auto btn btn-block bg-white p-3 fw-700 view-btn f-14" style="font-family: 'Roboto', sans-serif;" id= "loadMore"> Load More </a>
                </div>
            </div>
    ...
    <!-- Buy Ads Section -->
        ...
        <div class="container py-4">
            <div class="row">
                <div class="col-lg-2"></div>
                <div class="col-lg-10">
                    <h2 class="py-3 text-left w-700" style="font-size:24px; font-family: 'Roboto', sans-serif;">All Buy Ad</h2>
                    <div id="myCarouselbuy"  class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div id="myCarouselbuy"  class="carousel slide" data-ride="carousel">
                            <div class="carousel-item active">
                                <img src="{{ asset('frontend/assets/images/bannar1.gif') }}" alt="" class="banner1">
                            </div>
                    ...
                    <div class="carousel-item">
                        <a href="https://sobkisubazar.com/">
                            <img src="{{ asset('frontend/assets/images/banner4.png') }}" alt="" class="banner1">                       
                        </a>
            ...
            <div class="row">
                <div class="col-lg-2"></div>
                <div class="col-lg-5">
                    <div class="contentBuy"><a href="#">
                            <img src="{{ asset('frontend/assets/images/1.png') }}" alt="" class="saleimg">
                        </a>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="contentBuy"><a href="#">
                            <img src="{{ asset('frontend/assets/images/2.png') }}" alt="" class="saleimg-mt">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="pt-4">
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="contentBuy"><a href="#">
                            <img src="{{ asset('frontend/assets/images/4.png') }}" alt="" class="saleimg">
                        </a>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="contentBuy"><a href="#">
                            <img src="{{ asset('frontend/assets/images/3.png') }}" alt="" class="saleimg-mt">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-2"></div>
                <div class="col-lg-5">
                    <div class="contentBuy mt-4"><a href="#">
                            <img src="{{ asset('frontend/assets/images/s1.jpg') }}" alt="" class="saleimg">
                        </a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="contentBuy mt-4"><a href="#">
                            <img src="{{ asset('frontend/assets/images/2.png') }}" alt="" class="saleimg">
                        </a>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="contentBuy mt-4"><a href="#">
                            <img src="{{ asset('frontend/assets/images/3.png') }}" alt="" class="saleimg">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-4">
                <div class="col-lg-2"></div>
                <div class="col-lg-10">
                <a href = "#" class="ml-auto btn btn-block bg-white p-3 fw-700 view-btn f-14" style="font-family: 'Roboto', sans-serif;" id= "loadMoreBuy"> Load More </a>
                </div>
            </div>
    ...
    <section id='rentAd' class="">
        ...
        <div class="container py-4">
            <div class="row">
                <div class="col-lg-2"></div>
                <div class="col-lg-10">
                    <h2 class="py-3 text-left w-700" style="font-size:24px; font-family: 'Roboto', sans-serif;">All Rent Ad</h2>
                    ...
                    <div class="carousel-item">
                        <a href="https://sobkisubazar.com/">
                            <img src="{{ asset('frontend/assets/images/banner3.png') }}" alt="" class="banner1">                       
                        </a>
        ...
        <div class="pt-4">
            ...
            <div class="row mt-4">
                <div class="col-lg-2"></div>
                <div class="col-lg-10">
                <a href = "#" class="ml-auto btn btn-block bg-white p-3 fw-700 view-btn f-14" style="font-family: 'Roboto', sans-serif;" id= "loadMoreRent"> Load More </a>
                </div>
            </div>
